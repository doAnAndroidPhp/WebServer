                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    ...
                                    <p class="text-muted mb-4 mt-3">Enter username and password to access admin panel.</p>
                                </div>
                                ...
                                <form action="{{ route('xl-dang-nhap') }}" method="POST">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" name="ten_dang_nhap" required="" placeholder="Enter username">
                                    </div>
