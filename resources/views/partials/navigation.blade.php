        ...
        <div class="container-fluid">
            <div id="navigation">
                ...
                <ul class="navigation-menu">
                    ...
                    <li class="has-submenu">
                        <a href="{{ route('quan-tri-vien.danh-sach') }}"> <i class="la la-flask"></i>Quản trị viên</a>
                   
                    </li>

                    <li class="has-submenu">
                        <a href="{{ route('cau-hinh-app.danh-sach') }}"> <i class="fe-settings"></i>Cấu hình<div class="arrow-down"></div></a>
