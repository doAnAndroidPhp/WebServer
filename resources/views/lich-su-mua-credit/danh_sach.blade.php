                ...
                <table id="lich-su-mua-credit-table" class="table dt-responsive nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$LichSuMuaCredit->goi_credit}}</td>
                            <td>{{$LichSuMuaCredit->credit}}</td>
                            <td>{{$LichSuMuaCredit->so_tien}}</td>
                            <td>
                                <a href="{{route('lich-su-mua-credit.cap-nhat', ['id' => $LichSuMuaCredit->id]) }}" class="btn btn-success waves-effect waves-light">
                                   <i class="mdi  mdi-pencil-outline"></i>
                                </a>
                                <a href="{{route('lich-su-mua-credit.xoa', ['id' => $LichSuMuaCredit->id]) }}" class="btn btn-danger waves-effect waves-light">
