                ...
                <table id="luot-choi-table" class="table dt-responsive nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('luot-choi.cap-nhat', ['id' => $LuotChoi->id]) }}" class="btn btn-success waves-effect waves-light">
                                   <i class="mdi  mdi-pencil-outline"></i>
                                </a>
                                <a href="{{route('luot-choi.xoa', ['id' => $LuotChoi->id]) }}" class="btn btn-danger waves-effect waves-light">
